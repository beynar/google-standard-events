declare namespace GOOGLE_STANDARDS_EVENTS {
    ...
    /** The items for the event. */
    interface ADD_PAYMENT_INFO_ITEM {
        /** The ID of the item.
    ...
    /** The items for the event. */
    interface ADD_SHIPPING_INFO_ITEM {
        /** The ID of the item.
         * One of item_id or item_name is required.
         * @example SKU_12345 */
        item_id: string;
    ...
    /** The items for the event. */
    interface ADD_TO_WISHLIST_ITEM {
        /** The ID of the item.
         * One of item_id or item_name is required.
         * @example SKU_12345 */
        item_id: string;
    ...
    /** This event signifies a user has submitted their payment information. */
    interface EARN_VIRTUAL_CURRENCY {
    ...
    /** The items for the event. */
    interface REMOVE_FROM_CART_ITEM {
        /** The ID of the item.
         * One of item_id or item_name is required.
         * @example SKU_12345 */
        item_id: string;
    ...
    /** The items for the event. */
    interface SELECT_PROMOTION_ITEM {
        /** The ID of the item.
         * One of item_id or item_name is required.
         * @example SKU_12345 */
        item_id: string;
    ...
    /** This event signifies a user has submitted their payment information. */
    interface SPEND_VIRTUAL_CURRENCY {
        /** The value of the virtual currency.
         * @example 5 */
        value: number;
        /** The name of the virtual currency.
    ...
    /** This event signifies a user has submitted their payment information. */
    interface TUTORIAL_BEGIN {
    }
    /** This event signifies a user has submitted their payment information. */
    interface TUTORIAL_COMPLETE {
    }
    /** This event signifies a user has submitted their payment information. */
    interface UNLOCK_ACHIEVEMENT {
    ...
    type EVENTS = keyof EVENTS_MAP;
    type PARAMS<E extends EVENTS> = EVENTS_MAP[E];
}

export { GOOGLE_STANDARDS_EVENTS as default };
